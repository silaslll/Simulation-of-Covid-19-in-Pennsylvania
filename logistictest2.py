...
#input the cumulative case from 200 days to 340 days as y_data1
x_data= range(370)
y_data= graph.x1
x_data1= range(0,110)
y_data1= graph.x1[230:340]
...
# the values are found by training data from 200 days to 340 days
parameter_K = 1100000
parameter_r = 0.03
...
xxx =  logistic_f(para_time, 144581.05701697)



#calculate the error
error_logi = np.abs(  y_data[340:370] - xxx[110:140])


#calculate the percentage of error
error_per = error_logi / y_data[340:370]

print(error_per )


t2 = np.linspace(0, 30,30)
plt.plot(t2 , error_logi )
